class MainLayer extends Layer {
    ...
    initiate() {
        ...
        this.secondsClock = new Clock(75, 70, '#9900ff',  date.getSeconds()*1000+date.getMilliseconds(), 1000*60);
        this.minutesClock = new Clock(150, 70, '#ff5050', date.getMinutes()*60+date.getSeconds(), 60*60);
        this.hoursClock = new Clock(225, 70, '#33ccff', date.getHours()*60+date.getMinutes(), 24*60);
        this.daysClock = new Clock(300, 70, '#990000', date.getDay()*24+date.getHours(), 7*24);
        this.monthClock = new Clock(375, 70, '#66ff99', date.getDate()*24+date.getHours(),
